  ...
  try {
    ...
    for (const target of runtimeTargets) {
      ...
      runCheckedCommand({
        ...
        args: [
          "-c",
          "import numpy, pandas, openpyxl, xlrd, lxml, requests, matplotlib, scipy, scipy.io, scipy.optimize, scipy.stats, sklearn, seaborn, statsmodels; assert scipy.optimize.brentq(lambda x: x - 2, 0, 4) == 2; print('managed science runtime ready')",
        ],
        env: pythonEnv,
        verbose,
      });
