...
const afterPackHookSource = `
import { spawnSync } from "node:child_process";
import { copyFileSync, existsSync, readdirSync } from "node:fs";
import { join } from "node:path";

const MAC_APP_ICON_FILE = "${MAC_APP_ICON_ICNS_FILE}";
const MAC_APP_DOCK_ICON_FILE = "${MAC_APP_ICON_PNG_FILE}";
...
const buildDesktopArtifact = Effect.fn("buildDesktopArtifact")(function* (
  ...
  yield* fs.writeFileString(path.join(stageAppDir, AFTER_PACK_HOOK_FILE), afterPackHookSource);
