...
export const ResearchDepth = Schema.Literals(["standard", "max"]);
export type ResearchDepth = typeof ResearchDepth.Type;
...
export const PROVIDER_SEND_TURN_MAX_FILE_BYTES = 512 * 1024 * 1024;
...
export const ChatFileAttachment = Schema.Struct({
  ...
  sha256: TrimmedNonEmptyString.check(
    Schema.isMaxLength(64),
    Schema.isPattern(/^[a-f0-9]{64}$/i),
  ),
  storageName: TrimmedNonEmptyString.check(
...
const PaperMoveCommand = Schema.Struct({
  type: Schema.Literal("paper.move"),
  commandId: CommandId,
  threadId: ThreadId,
...
export const PaperMovedPayload = Schema.Struct({
  threadId: ThreadId,
