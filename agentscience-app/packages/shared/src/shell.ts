...
const PATH_CAPTURE_START = "__AGENTSCIENCE_PATH_START__";
const PATH_CAPTURE_END = "__AGENTSCIENCE_PATH_END__";
...
function envCaptureStart(name: string): string {
  return `__AGENTSCIENCE_ENV_${name}_START__`;
}

function envCaptureEnd(name: string): string {
  return `__AGENTSCIENCE_ENV_${name}_END__`;
}
