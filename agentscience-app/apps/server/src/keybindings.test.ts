import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@agentscience/contracts";
...
import { KeybindingsConfigError } from "@agentscience/contracts";
    ...
    Layer.provideMerge(
      Layer.fresh(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "agentscience-keybindings-test-",
        }),
      ),
    ),
  );
