 ...
 */
import { IsoDateTime, ModelSelection, ProjectId, ProjectScript } from "@agentscience/contracts";
...
>()("agentscience/persistence/Services/ProjectionProjects/ProjectionProjectRepository") {}
