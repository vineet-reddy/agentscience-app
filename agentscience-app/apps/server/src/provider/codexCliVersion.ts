...
export const MINIMUM_CODEX_CLI_VERSION = "0.128.0";
...
export function formatCodexCliUpgradeMessage(version: string | null): string {
  ...
  return `Codex CLI ${versionLabel} is too old for Agent Science. Upgrade to v${MINIMUM_CODEX_CLI_VERSION} or newer and restart Agent Science.`;
}
