import {
  ...
  ThreadStageStateUpdatedPayload as ContractsThreadStageStateUpdatedPayloadSchema,
...
export const ThreadStageStateUpdatedPayload =
  ContractsThreadStageStateUpdatedPayloadSchema;
