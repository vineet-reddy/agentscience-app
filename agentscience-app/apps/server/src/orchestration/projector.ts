...
export function projectEvent(
  ...
  switch (event.type) {
        ...
        const thread: OrchestrationThread = yield* decodeForEvent(
          OrchestrationThread,
          {
            ...
            workspaceKind:
              ...
              (payload.workflowMode && payload.workflowMode !== "open" ? "agent" : "paper"),
            ...
            checkpoints: [],
            session: null,
            ...(payload.stageState !== undefined ? { stageState: payload.stageState } : {}),
          },
          event.type,
          "thread",
        );
    ...
    case "paper.moved":
      return decodeForEvent(PaperMovedPayload, event.payload, event.type, "payload").pipe(
        Effect.map((payload) => ({
          ...nextBase,
          threads: updateThread(nextBase.threads, payload.threadId, {
