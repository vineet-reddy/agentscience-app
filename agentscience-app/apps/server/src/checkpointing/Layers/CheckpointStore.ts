...
import { CheckpointRef } from "@agentscience/contracts";
...
const makeCheckpointStore = Effect.gen(function* () {
  ...
  const captureCheckpoint: CheckpointStoreShape["captureCheckpoint"] = Effect.fn(
    ...
    yield* Effect.acquireUseRelease(
      fs.makeTempDirectory({ prefix: "agentscience-fs-checkpoint-" }),
      Effect.fn("captureCheckpoint.withTempDirectory")(function* (tempDir) {
        ...
        const commitEnv: NodeJS.ProcessEnv = {
          ...
          GIT_AUTHOR_NAME: "Agent Science",
          GIT_AUTHOR_EMAIL: "agentscience@users.noreply.github.com",
          GIT_COMMITTER_NAME: "Agent Science",
          GIT_COMMITTER_EMAIL: "agentscience@users.noreply.github.com",
        };
        ...
        const message = `agentscience checkpoint ref=${input.checkpointRef}`;
