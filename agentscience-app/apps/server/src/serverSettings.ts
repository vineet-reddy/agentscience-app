...
import { type DeepPartial, deepMerge } from "@agentscience/shared/Struct";
import { fromLenientJson } from "@agentscience/shared/schemaJson";
...
export class ServerSettingsService extends ServiceMap.Service<
  ...
  ServerSettingsShape
>()("agentscience/serverSettings/ServerSettingsService") {
...
const PROVIDER_ORDER: readonly ProviderKind[] = ["codex", "gemini"];
