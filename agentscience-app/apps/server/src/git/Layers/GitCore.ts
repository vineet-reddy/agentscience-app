...
import { GitCommandError, type GitBranch } from "@agentscience/contracts";
import { dedupeRemoteBranchesWithLocalMatches } from "@agentscience/shared/git";
...
import { decodeJsonResult } from "@agentscience/shared/schemaJson";
...
> {
  ...
  const traceFilePath = yield* fs.makeTempFileScoped({
    prefix: `agentscience-git-trace2-${process.pid}-`,
    suffix: ".json",
  });
