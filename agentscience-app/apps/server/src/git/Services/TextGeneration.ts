...
import type { ChatAttachment, ModelSelection } from "@agentscience/contracts";

import type { TextGenerationError } from "@agentscience/contracts";

/** Providers that support git text generation (commit messages, PR content, branch names). */
export type TextGenerationProvider = "codex" | "gemini";
...
export class TextGeneration extends ServiceMap.Service<TextGeneration, TextGenerationShape>()(
  "agentscience/git/Services/TextGeneration",
) {}
