import { type ContextMenuItem, type NativeApi } from "@agentscience/contracts";
...
export function createWsNativeApi(): NativeApi {
  ...
  const api: NativeApi = {
    ...
    server: {
      ...
      refreshAgentScienceRuntimeStatus: rpcClient.server.refreshAgentScienceRuntimeStatus,
      ...
      cancelAgentScienceLogin: rpcClient.server.cancelAgentScienceLogin,
      signOutAgentScience: rpcClient.server.signOutAgentScience,
    },
    orchestration: {
